...
INVENTORY = REPO_ROOT / "docs/compatibility/dynamodb-persisted-formats-v2.json"
...
class PersistedFormatReleaseTests(unittest.TestCase):
    ...
    def write_notes(self, digest: str, changes: str = "None.") -> None:
        self.notes.write_text(
            ...
            f"- DynamoDB persisted-format contract: inventory `v2`, `sha256:{digest}`.\n"
    ...
    def test_v1_baseline_inventory_accepts_additive_v2_identity_set(self) -> None:
        ...
        self.write_notes(
            digest,
            "Added atomicTransactWrite_v3 and atomicTransactGet_v1 while retaining v2 hashes.",
        )
        self.run_tool(expect_success=True)
