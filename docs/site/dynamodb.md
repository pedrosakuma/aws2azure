...
- Smoke-verified against the Cosmos DB Linux emulator (vNext preview) via Testcontainers; not yet exercised against real Azure Cosmos DB. LSI Query is emulator-verified only; not yet exercised against real Azure Cosmos DB.
