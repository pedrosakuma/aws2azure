...
| s3 | [DeleteBucketOwnershipControls](s3.md#deletebucketownershipcontrols) | 🟡 partial | — | `Conditional container-metadata update` |
...
| s3 | [DeletePublicAccessBlock](s3.md#deletepublicaccessblock) | 🟡 partial | — | `Conditional container-metadata update` |
| s3 | [GetBucketAccelerateConfiguration](s3.md#getbucketaccelerateconfiguration) | 🟡 partial | — | `(no equivalent — proxy returns stable Suspended)` |
...
| s3 | [GetBucketEncryption](s3.md#getbucketencryption) | 🟡 partial | — | `Container metadata for SSE-S3 intent; Azure Storage encryption remains account-managed` |
...
| s3 | [GetBucketOwnershipControls](s3.md#getbucketownershipcontrols) | 🟡 partial | — | `Container metadata (persisted compatibility intent only)` |
...
| s3 | [GetBucketRequestPayment](s3.md#getbucketrequestpayment) | 🟡 partial | — | `(no equivalent — proxy returns the S3 default body)` |
...
| s3 | [GetPublicAccessBlock](s3.md#getpublicaccessblock) | 🟡 partial | — | `Container metadata (persisted compatibility intent only)` |
...
| s3 | [PutBucketEncryption](s3.md#putbucketencryption) | 🟡 partial | — | `Conditional container-metadata update for SSE-S3 intent` |
...
| s3 | [PutBucketOwnershipControls](s3.md#putbucketownershipcontrols) | 🟡 partial | — | `Conditional container-metadata update (persisted compatibility intent only)` |
...
| s3 | [PutBucketRequestPayment](s3.md#putbucketrequestpayment) | 🟡 partial | — | `(no equivalent — BucketOwner is an accepted stable no-op)` |
