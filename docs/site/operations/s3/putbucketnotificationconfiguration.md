# s3 / PutBucketNotificationConfiguration {#operation-s3-putbucketnotificationconfiguration}

[← s3 operation index](../../s3.md) · [Coverage matrix](../../coverage.md)

- **Capability ID:** `operation:s3:putbucketnotificationconfiguration`
- **Status:** ⛔ unsupported
...
- **Capability ID:** `sub-feature:s3:putbucketnotificationconfiguration:configuration-storage`
- **Status:** ⛔ unsupported
- **Disposition:** 🔵 by design
