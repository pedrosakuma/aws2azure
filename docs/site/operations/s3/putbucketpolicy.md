# s3 / PutBucketPolicy {#operation-s3-putbucketpolicy}

[← s3 operation index](../../s3.md) · [Coverage matrix](../../coverage.md)

- **Capability ID:** `operation:s3:putbucketpolicy`
- **Status:** ⛔ unsupported
...
- **Capability ID:** `sub-feature:s3:putbucketpolicy:configuration-storage`
- **Status:** ⛔ unsupported
- **Disposition:** 🔵 by design
