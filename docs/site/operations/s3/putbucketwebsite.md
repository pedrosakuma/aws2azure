# s3 / PutBucketWebsite {#operation-s3-putbucketwebsite}

[← s3 operation index](../../s3.md) · [Coverage matrix](../../coverage.md)

- **Capability ID:** `operation:s3:putbucketwebsite`
- **Status:** ⛔ unsupported
...
- **Capability ID:** `sub-feature:s3:putbucketwebsite:configuration-storage`
- **Status:** ⛔ unsupported
- **Disposition:** 🔵 by design
