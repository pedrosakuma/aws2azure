# s3 / DeleteBucketPolicy {#operation-s3-deletebucketpolicy}

[← s3 operation index](../../s3.md) · [Coverage matrix](../../coverage.md)

- **Capability ID:** `operation:s3:deletebucketpolicy`
- **Status:** ⚪ stub
...
- **Capability ID:** `sub-feature:s3:deletebucketpolicy:idempotent-clear`
- **Status:** ✅ implemented
