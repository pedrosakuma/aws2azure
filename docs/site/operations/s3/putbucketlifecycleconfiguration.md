# s3 / PutBucketLifecycleConfiguration {#operation-s3-putbucketlifecycleconfiguration}

[← s3 operation index](../../s3.md) · [Coverage matrix](../../coverage.md)

- **Capability ID:** `operation:s3:putbucketlifecycleconfiguration`
- **Status:** ⛔ unsupported
...
- **Capability ID:** `sub-feature:s3:putbucketlifecycleconfiguration:configuration-storage`
- **Status:** ⛔ unsupported
- **Disposition:** 🔵 by design
