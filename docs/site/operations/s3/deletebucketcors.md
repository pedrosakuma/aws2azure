# s3 / DeleteBucketCors {#operation-s3-deletebucketcors}

[← s3 operation index](../../s3.md) · [Coverage matrix](../../coverage.md)

- **Capability ID:** `operation:s3:deletebucketcors`
- **Status:** ⚪ stub
...
- **Capability ID:** `sub-feature:s3:deletebucketcors:idempotent-clear`
- **Status:** ✅ implemented
