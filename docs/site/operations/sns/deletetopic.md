...
- DeleteTopic parses the topic name out of the ARN with the same AWS-side [A-Za-z0-9_-]{1,256}(.fifo) contract CreateTopic enforces at creation time and uses that topic-name suffix directly for the Azure delete.
