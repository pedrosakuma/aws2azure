...
**Impact.** Callers that validate exact AWS ARN region/account/suffix structure, persist AWS account IDs from ARNs, or depend on partial-ARN matching edge cases can observe non-AWS shapes.
