...
| [kinesis](#kinesis) | <a id="kinesis-event-hubs-capture-archives-event-hubs-envelopes-not-raw-kinesis-bytes"></a><a id="event-hubs-capture-archives-event-hubs-envelopes-not-raw-kinesis-bytes" data-legacy-fragment="true"></a>[Event Hubs Capture archives Event Hubs envelopes, not raw Kinesis bytes](design-gaps/kinesis/event-hubs-capture-archives-event-hubs-envelopes-not-raw-kinesis-bytes.md) | 🔵 by design | 🔵 by design | — |
| [kinesis](#kinesis) | <a id="kinesis-geo-dr---geo-replication-failover-requires-alias-planning-and-breaks-iterator-continuity"></a><a id="geo-dr-geo-replication-failover-requires-alias-planning-and-breaks-iterator-continuity" data-legacy-fragment="true"></a>[Geo-DR / Geo-Replication failover requires alias planning and breaks iterator continuity](design-gaps/kinesis/geo-dr---geo-replication-failover-requires-alias-planning-and-breaks-iterator-continuity.md) | 🔵 by design | 🔵 by design | — |
| [kinesis](#kinesis) | <a id="kinesis-idempotent-or-exclusive-event-hubs-producers-are-unsupported"></a><a id="idempotent-or-exclusive-event-hubs-producers-are-unsupported" data-legacy-fragment="true"></a>[Idempotent or exclusive Event Hubs producers are unsupported](design-gaps/kinesis/idempotent-or-exclusive-event-hubs-producers-are-unsupported.md) | 🔵 by design | 🔵 by design | — |
...
| [secretsmanager](#secretsmanager) | <a id="secretsmanager-hierarchical--slash-containing--secret-names-require-key-vault-name-translation"></a><a id="hierarchical-slash-containing-secret-names-require-key-vault-name-translation" data-legacy-fragment="true"></a>[Hierarchical (slash-containing) secret names require Key Vault name translation](design-gaps/secretsmanager/hierarchical--slash-containing--secret-names-require-key-vault-name-translation.md) | 🔵 by design | 🔵 by design | — |
...
- [Hierarchical (slash-containing) secret names require Key Vault name translation](design-gaps/secretsmanager/hierarchical--slash-containing--secret-names-require-key-vault-name-translation.md) — 🔵 by design · `design-gap:secretsmanager:hierarchical--slash-containing--secret-names-require-key-vault-name-translation`
