...
{
    public const int InventoryVersion = 3;
    ...
    public const int StoredProcedureIdentityVersion = 3;
    ...
    public const string AtomicTransactWriteStoredProcedureId = "atomicTransactWrite_v4";
    ...
    // Frozen by the v3 inventory. Body changes require another new ID.
